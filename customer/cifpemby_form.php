...
$this->title = 'Maintenance CIF Pembiayaan';
$this->registerCss(".required label:after { content:' *';color:red; }");
?>
<div class="maintain-form">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php echo Yii::$app->session->getFlash('maintainCifpembyfailed'); ?>
    ...
    <div class="maintain-form">
        ...
        'items' => [
            [
                'label' => 'Nasabah',
                'content' => $this->render('cifpemby_form_tab1', ['model' => $model, 'form' => $form]),
                //'active' => true itu maksudnya tab mana yang dibuka pertama kali ngeLoad
                'active' => true
            ],
            [
                'label' => 'Alamat',
                'content' => $this->render('cifpemby_form_tab2', ['model' => $model, 'form' => $form]),
            ],
            [
                'label' => 'Pekerjaan',
                'content' => $this->render('cifpemby_form_tab3', ['model' => $model, 'form' => $form]),

            ],
            [
                'label' => 'Informasi Lainnya',
                'content' => $this->render('cifpemby_form_tab4', ['model' => $model, 'form' => $form]),

            ],
            [
                'label' => 'Audit',
                'content' => $this->render('cifpemby_form_tab5', ['model' => $model, 'form' => $form]),
