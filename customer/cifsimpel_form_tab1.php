...
<br>
    <?= $form->field($model, 'cust_title_1')->dropDownList(\app\models\CusTitle::getCusTitle(), ['prompt' => 'Pilih Gelar Sebelum Nama']) ?>

    <?= $form->field($model, 'short_name')->textInput(['maxlength' => true]) ?>
    <?= $form->field($model, 'cust_title_2')->dropDownList(\app\models\CusTitle::getCusTitle(), ['prompt' => 'Pilih Gelar Sesudah Nama']) ?>
    ...
    <?= $form->field($model, 'religion')->dropDownList(\app\models\Longcif::getReligion(), ['prompt' => 'Pilih Agama']) ?>
    ...
    <?= $form->field($model, 'legal_type')->dropDownList(['01-KTP' => 'KTP', '02-SIM' => 'SIM', '03-PASSPORT/KITAS/KIMS' => 'PASSPORT/KITAS/KIMS','04-NIK' => 'NIK','05-NIS' => 'NIS','06-NISN' => 'NISN',], ['prompt' => 'Pilih Jenis Identitas']) ?>

    <?php //$form->field($model, 'legal_id_no')->textInput(['maxlength' => 16]) ?>

    <?= $form->field($model, 'legal_id_no')->textInput(['maxlength' => true]) ?>
    
    <?= $form->field($model, 'school_code')->dropDownList(\app\models\Institution::listInstitution(), ['prompt' => '----Pilih Sekolah----']) ?>
