...
$this->title = 'Otorisasi Perubahan Data CIF Pembiayaan - ' . $updatelog->cif_no;
...
<div class="custtomer-update-view-otor">
    ...
    <?php
    if ($updatelog->status == app\models\CifpembyUpdateLog::INAU) {
        ...
        echo Html::a('Hapus', ['/customer/hapusupdatecifpemby','id'=>$updatelog->id], ['class'=>'btn btn-danger','style'=>'margin-left:10px','onclick'=>'return confirm("Hapus data ini ?")']);
        echo '</div>';
        ActiveForm::end();
    }
    ?>
